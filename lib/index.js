    ...
    stopAllTasks() {
        try {
            this.tasks.forEach(task => {
                ...
                if (this.intervals[(_a = task.id) !== null && _a !== void 0 ? _a : ""]) {
                    clearInterval(this.intervals[(_b = task.id) !== null && _b !== void 0 ? _b : ""]);
                    delete this.intervals[(_c = task.id) !== null && _c !== void 0 ? _c : ""];
                }
            });
        ...
        try {
            ...
            const [minute, hour, dayOfMonth, month, dayOfWeek] = parts.map(p => {
                if (p === '*')
                    return null;
                if (p.includes('/'))
                    return parseInt(p.split('/')[1], 10); // Handle step values like '*/5'
